        ...
        <section className="relative w-full px-[24px] sm:px-[106px]">
          <div className="relative mx-auto flex w-full max-w-[1048px] flex-col items-center text-center">
            <div className="relative left-1/2 w-screen -translate-x-1/2 self-start">
              <p
                aria-hidden
                className="mt-[80px] w-full select-none bg-gradient-to-t from-[#0c1728] via-[#d9ebf8] to-[#f4fafd] bg-clip-text text-center font-heading text-[clamp(32px,13vw,223px)] font-black uppercase whitespace-nowrap leading-none text-transparent opacity-[0.43] sm:mt-[89px] sm:leading-[1.05] sticky top-60 md:top-20"
              >
                Fáza 0
              </p>
            </div>
