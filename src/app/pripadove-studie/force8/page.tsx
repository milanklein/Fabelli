  ...
  return (
    ...
    <section className="mt-[64px] w-full px-[24px] md:mt-[100px] md:px-[106px]">
        ...
        <section className="mt-[64px] w-full md:mt-[100px]">
          <GallerySlider
            images={[
              "/images/case-studies/force8-michal-pataky/gallery-1.webp",
              "/images/case-studies/force8-michal-pataky/gallery-2.webp",
              "/images/case-studies/force8-michal-pataky/gallery-3.webp",
              "/images/case-studies/force8-michal-pataky/gallery-4.webp",
            ]}
          />
        </section>
        ...
        <section className="mt-[64px] w-full px-[24px] md:mt-[100px] md:px-[106px]">
          <div className="mx-auto flex w-full max-w-[1234px] flex-col items-center gap-[20px] md:gap-[42px]">
            ...
            <OtherProjectsSlider currentSlug="force8" />
          </div>
        </section>
