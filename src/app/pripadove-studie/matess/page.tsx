...
export const metadata: Metadata = {
  ...
  openGraph: {
    title,
    description,
    images: [{ url: "/thumbnails/thumbnail_matess.png", width: 1200, height: 630 }],
  },
  twitter: {
    card: "summary_large_image",
    title,
    description,
    images: ["/thumbnails/thumbnail_matess.png"],
  },
};
    ...
    <div className="relative h-[280px] w-[142px] shrink-0 overflow-hidden rounded-[26px] shadow-[0px_0px_43px_0px_rgba(219,236,248,0.59)] md:h-[553px] md:w-[280px] md:rounded-[40px]">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <Image
          ...
          width={88}
          height={88}
          className="size-[44px] md:size-[64px]"
        />
      </div>
    </div>
  );
  ...
  return (
    <>
      <main className="flex flex-1 flex-col bg-background overflow-hidden">
            ...
            <div className="flex w-full flex-col items-center justify-center md:items-start  gap-[40px] md:flex-row md:gap-[60px] ">
              ...
              <div className="flex w-full flex-1 flex-col items-start gap-[30px] md:pt-[51px]">
                ...
                <Reveal immediate delay={250} duration={500}>
                  <ul className="flex md:w-full list-disc flex-col gap-[16px] pl-[20px] font-sans text-[16px] text-white md:text-[20px]">
                    <li>
        ...
        <section className="relative w-full px-4 md:px-[106px]">
          <div className="relative mx-auto flex w-full max-w-[1048px] flex-col items-center text-center">
            ...
            <Reveal
              duration={600}
              className="bg-gradient-to-b from-transparent to-[#0C1728] to-10% -mt-[10px] w-full max-w-[621px] font-sans text-[16px] text-white md:-mt-[20px] md:text-[20px] leading-[120%] mt-10 pt-4" 
            >
              <p>
          ...
          <div className="relative mx-auto flex w-full max-w-[1048px] flex-col items-center gap-[48px]">
            <div className="flex w-full max-w-[621px] flex-col items-center gap-[20px] text-center">
              ...
              <Reveal delay={100} duration={500}>
                <ul className="flex w-full list-disc flex-col gap-[10px] pl-[20px] text-left font-sans text-center text-[16px] text-white md:text-[20px]">
            ...
            <div className="flex w-full flex-col items-center gap-[32px] md:flex-row md:items-start md:justify-center md:gap-[54px]">
              {[
                ...
                >
                  <div
                    className="animate-float relative aspect-[297/499] w-full overflow-hidden rounded-[16px] md:rounded-[24px] py-8"
                  ...
                  <p className="bg-gradient-to-r from-heading-from to-heading-to bg-clip-text text-center font-heading text-[16px] font-black text-transparent md:text-[19px] leading-[120%]">
                    {funnel.caption}
                  </p>
                </Reveal>
              ))}
        ...
        <section className="relative mt-[64px] w-full px-[24px] md:mt-[100px] md:px-[106px]">
          <div className="mx-auto flex w-full max-w-[1234px] flex-col items-center gap-[40px] md:flex-row md:items-start md:gap-[54px]">
            <Reveal
              duration={700}
            ...
            <div className="flex w-[320px] md:w-full  flex-col items-start gap-[40px] md:gap-[60px]">
              <h2 className="bg-gradient-to-r from-heading-from to-heading-to bg-clip-text font-heading text-[20px] font-black uppercase text-transparent md:text-[24px]">
                <RevealText>Tieto funnely priniesli:</RevealText>
              </h2>
              <div className="grid w-full grid-cols-1 gap-[24px] md:grid-cols-2 md:gap-[43px]">
                {stats.map((stat, i) => (
                  <Reveal
                    key={stat.label}
                    delay={i * 100}
        ...
        <section className="mt-[64px] w-full px-[24px] md:mt-[100px] md:px-[106px]">
          <div className="mx-auto flex w-full max-w-[764px] flex-col items-center gap-[48px] md:gap-[64px]">
            {results.map((result, i) => (
              ...
              >
                <p className="w-2/3 bg-gradient-to-r from-heading-from to-heading-to bg-clip-text text-center font-heading text-[13px] font-black uppercase text-transparent md:text-[16px]">
                  {result.label}
                </p>
                <div className="relative h-auto w-full overflow-hidden rounded-[16px] md:rounded-[28px]">
                  <Image
                    src={result.image}
                    alt=""
                    width={764}
