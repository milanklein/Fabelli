...
const testimonials = [
  ...
  {
    id: "8e4c85c8-7338-4f6c-a684-286408fb5b4c",
    quote: "Fabiánov prístup k práci je veľmi cieľavedomý.",
    name: "Dávid",
  },
  {
    id: "c2ec20de-a271-4515-ae8e-2b833b53a3e1",
    quote: "Uvedomenie, že sú výsledky prišlo s tým, že sa mi naplnili kurzy",
    name: "Žaneta",
  },
  {
    id: "0b6af2b7-0e09-4e76-b6b5-a77e5419b9f1",
    quote: "Nie každý dokázal poskytnúť tak komplexnú službu a s takými výsledkami.",
    name: "Michal",
  },
...
export default function TestimonialsTY() {
